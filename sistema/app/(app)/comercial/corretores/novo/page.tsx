...
export default async function NovoCorretorPage() {
  await requirePermission('brokers:manage')
  const imobiliarias = await getImobiliarias()
    ...
    <div className="p-8 max-w-2xl">
      ...
      <form action={criarCorretor} className="bg-white border border-gray-200 rounded p-6 space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/comercial/corretores" className="px-5 py-2 rounded text-sm text-gray-600 hover:bg-gray-100 transition-colors">
            Cancelar
          </Link>
        </div>
      </form>
