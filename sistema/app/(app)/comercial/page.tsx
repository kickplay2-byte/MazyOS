...
export default async function ComercialPage() {
  await requirePermission('commercial:view')
  const [imobiliarias, corretores, clientes, propostasAbertas, propostasAceitas, propostasVencidas, valorAbertas, valorAceitas, taxaConversao] = await Promise.all([
    getImobiliarias(), getCorretores(), getClientes(),
    getPropostasAbertas(), getPropostasAceitas(), getPropostasVencidas(),
    getValorPropostasAbertas(), getValorPropostasAceitas(), getTaxaConversaoPropostas(),
  ])
