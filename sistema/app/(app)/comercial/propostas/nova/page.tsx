...
export default async function NovaPropostaPage({
  ...
  const [oportunidades, clientes, corretores, imobiliarias, oportunidadePre] = await Promise.all([
    getOportunidades(),
    getClientes(),
    getCorretores(),
    getImobiliarias(),
    params.oportunidadeId ? getOportunidade(params.oportunidadeId) : Promise.resolve(undefined),
  ])
