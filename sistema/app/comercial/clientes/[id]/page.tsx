...
export default async function ClienteDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const corretor = cliente.corretorId ? getCorretor(cliente.corretorId) : undefined
  const imobiliaria = cliente.imobiliariaId ? getImobiliaria(cliente.imobiliariaId) : undefined
