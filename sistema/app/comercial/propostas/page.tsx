...
export default async function PropostasPage({
  ...
  const imobiliariaMap = Object.fromEntries(imobiliarias.map((i) => [i.id, i.nome]))
  ...
  // KPIs
  const abertas = getPropostasAbertas()
  const aceitas = getPropostasAceitas()
  const recusadas = getPropostasRecusadas()
  const vencidas = getPropostasVencidas()
